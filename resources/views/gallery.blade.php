                                    ...
                                    <div class="single-portfolio">
                                        <div class="poftfolio-info">
                                            <div class="poftfolio-img">
                                                <img src="{{ asset('storage/' . $gallery->image) }}" alt="{{ $gallery->title }}" style="width: 100%; height: auto; object-fit: cover;">
                                            </div>
                                        </div>
                                            ...
                                            <div class="portfolio-inner-content">
                                                <div class="portfolio-detels">
                                                    ...
                                                    <div class="portfolio-btn">
                                                        <a href="{{ asset('storage/' . $gallery->image) }}" data-lightbox="example-set" data-title="{{ $gallery->title }}">Full View</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
